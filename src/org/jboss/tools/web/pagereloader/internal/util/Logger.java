...
public final class Logger {
	...
	private static final String INFO = JBossWebPageReloaderPlugin.PLUGIN_ID + "/info";

	/** The 'debug' level name, matching the .options file. */
	private static final String DEBUG = JBossWebPageReloaderPlugin.PLUGIN_ID + "/debug";

	/** The 'trace' level name, matching the .options file. */
	private static final String TRACE = JBossWebPageReloaderPlugin.PLUGIN_ID + "/trace";
	...
	public static void error(final String message, final Throwable t) {
		if (JBossWebPageReloaderPlugin.getDefault() != null) {
			JBossWebPageReloaderPlugin.getDefault().getLog()
					.log(new Status(Status.ERROR, JBossWebPageReloaderPlugin.PLUGIN_ID, message, t));
		} else {
	...
	public static void error(final String message) {
		JBossWebPageReloaderPlugin.getDefault().getLog()
				.log(new Status(Status.ERROR, JBossWebPageReloaderPlugin.PLUGIN_ID, message));
	}
	...
	public static void warn(final String message, final Throwable t) {
		JBossWebPageReloaderPlugin.getDefault().getLog()
				.log(new Status(Status.WARNING, JBossWebPageReloaderPlugin.PLUGIN_ID, message, t));
	}
	...
	public static void warn(final String message) {
		JBossWebPageReloaderPlugin.getDefault().getLog()
				.log(new Status(Status.WARNING, JBossWebPageReloaderPlugin.PLUGIN_ID, message));
	}
	...
	public static void info(String message) {
		if (isOptionEnabled(INFO)) {
			JBossWebPageReloaderPlugin.getDefault().getLog()
					.log(new Status(Status.INFO, JBossWebPageReloaderPlugin.PLUGIN_ID, message));
		}
	}
	...
	private static boolean isOptionEnabled(String level) {
		...
		return JBossWebPageReloaderPlugin.getDefault() != null && JBossWebPageReloaderPlugin.getDefault().isDebugging()
