...
public class LiveReloadScriptFileFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
			ServletException {
		Logger.debug("Serving /livereload/livereload.js !");
		HttpServletResponse httpServletResponse = (HttpServletResponse) response;
		final InputStream scriptContent = JBossWebPageReloaderPlugin.getDefault().getResourceContent("/script/livereload.js");
